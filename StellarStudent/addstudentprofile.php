	...
	if(isset($_POST['submit']))
	{
		...
		if(isset($_GET['editid']))
		{
			...
			if($_FILES["profileimage"]["name"] != "")
					...
					$sql = $sql .  "course_id='$_POST[course]',semester='$_POST[semester]',about_student='$aboutus',email_id='$_POST[emailid]',mob_no='$_POST[mobileno]',status='$_POST[status]',batch='$_POST[batch]' WHERE student_id='" . $_GET['editid']  . "'";
		...
		else
		{
			...
			{
				$sql="INSERT INTO student(student_name,roll_no,password,student_img,course_id,semester,about_student,email_id,mob_no,status,batch) values ('$_POST[name]','$_POST[rollno]','$ectpass','$imgname','$_POST[course]','$_POST[semester]','$aboutus','$_POST[emailid]','$_POST[mobileno]','$_POST[status]','$_POST[batch]')";
				$qsql = mysqli_query($con,$sql);
				if(!$qsql)
				{
					echo mysqli_error($con);
				...
				if(mysqli_affected_rows($con) == 1)
				{
					echo "<SCRIPT>alert('Your Account registered successfully.. Admin verification required to activate your account.');</SCRIPT>";
					echo "<script>window.location='addstudentprofile.php';</script>";			
				}
			}
		}
	}
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="contact_area">
            ...
            <p>To add a new student, enter the following details...</p>
            ...
            <input  type="hidden" name="sessionid" value="<?php echo $_SESSION['sessionid']; ?>" >
              ...
              <input name="name" class="form-control" type="text" placeholder="Name" value="<?php echo $rsedit['student_name']; ?>"
               ...
               <span id="idname"></span>
              	<br>
				Batch :<font color='red' size='4'><strong>*</strong></font>
              <input name="batch" id="batch" class="form-control" type="number" placeholder="Enter Year" value="<?php echo $rsedit['batch']; ?>" min="1950" max="<?php echo date("Y"); ?>" />
...
?>
              ...
              <input type="hidden" name="dbidrollno" value="1">
 ...
 <br>
              About me:
              <textarea name="aboutus" class="form-control" cols="30" rows="10" placeholder="About Me" ><?php echo $rsedit['about_student']; ?></textarea>
             <br />        	
              ...
              <input name="emailid" class="form-control" type="email" placeholder="Email Id" value="<?php echo $rsedit['email_id']; ?>" >
               <span id="idemailid"></span>
              	<br>
              Mobile No:<font color='red' size='4'><strong>*</strong></font>
 ...
 function validateform()
 {
	...
	document.getElementById("idbatch").innerHTML ="";
	  ...
	  if(document.frmstudent.name.value=="")
	 {
	  ...
	  if(document.frmstudent.batch.value=="")
	 {
		 document.getElementById("idbatch").innerHTML ="<font color='red'>Kindly Enter Batch or Year.</font>";
		 validatecondtion=1;
	 }
	 if(!document.frmstudent.rollno.value.match(alphanumbericExp))
	 {
		 document.getElementById("idrollno").innerHTML ="<font color='red'>Only Alphabets and numeric values allowed....</font>";
		 validatecondtion=1;
	 }
	...
	if(document.frmstudent.mobileno.value.length != 10 )
	{
