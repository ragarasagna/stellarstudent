...
?>
  <section id="contentSection">
    <div class="row">
           ...
           <p>Choose the appropriate subject to view uploaded study materials.</p>

<form class="contact_form" method="get" >
<?php
  	  $sqlsubject = "SELECT * FROM subject WHERE course_id='$rsstudent[course_id]' ";
...
<?php
   $sql ="SELECT * FROM study_material WHERE  course_id='$rsstudent[course_id]'  AND subject_id='$_GET[subjectid]'";
  $qsql = mysqli_query($con, $sql);
