        ...
        <div class="panel panel-info">
            ...
            <div class="panel-footer">
                <div class="input-group">
                                    <input type="text" class="form-control" name="grptextmsg" id="grptextmsg" placeholder="Enter Message" onKeyUp="submitgroupchat(coursetitle.value,grptextmsg.value,event)" />
                                    <span class="input-group-btn">
                                        <button class="btn btn-info" type="button" onClick="submitgroupchatbtn(coursetitle.value)">Send</button>
                                    </span>
                                </div>
            </div>
        </div>
...
function submitgroupchat(coursetitle,textmsg,e)
{
	if(textmsg != "")
	{
		...
		if(code == 13) //Enter keycode
		{
			...
			$.post("jsgroupchatmsg.php", { coursetitle: coursetitle, textmsg: textmsg});
		}
	}
}
function submitgroupchatbtn(coursetitle,smiley)
{
	var smiley = "<?php
		...
		?>";
			$.post("jsgroupchatmsg.php", { coursetitle: coursetitle, textmsg: smiley});
}
         ...
         function loadgroupchat()
         {
			...
			//alert(localStorage['visiblechat1']);
			 				//Load message to chat box 1
								 $.post("groupchatmsg.php", { coursetitle: coursetitle},
								   function(data) 
								   {
										//alert(data);	
										  if(data == chatdata1)
