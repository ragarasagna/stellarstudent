  ...
  <header id="header">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <img src="SS1.jpeg" alt="" style="height:80px;" align="left">
         <a href="index.php" class="logo"><img src="vishnulogo.jpg" alt="" style="height:70px;" align="right"></a>
        </div>
      </div>
    </div>
  </header>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav main_nav">
          ...
          <li style="position: absolute; right: 0px; width: 150px;"><a href="studentforgetpassword.php">Forgot Password</a></li>   
          <?php
			 }
		 ?>                 
      <?php  
		...
		?>
          <li><a href="dashboard.php">Dashboard</a></li>
           <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Timeline</a>
...
?>
           <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Materials</a>
            <ul class="dropdown-menu" role="menu">
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Student Account</a>
            <ul class="dropdown-menu" role="menu">
			  <li><a href="addstudentprofile.php">Add New Student</a></li>
			  <li><a href="viewstudentprofile.php?st=Active">View Student Profile</a></li>
			  <li><a href="viewstudentprofile.php?st=Inactive">View Suspended Accounts</a></li>
			  <li><a href="viewstudentprofile.php?st=Pending">View Pending Verification</a></li>
            </ul>
          </li> 
		  
		<li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Certifications</a>
			<ul class="dropdown-menu" role="menu">
			  
			  <li><a href="viewcertificates.php?status=Accept">View Certificates</a></li>
			  <li><a href="viewcertificates.php?status=Pending">View Pending Verification</a></li>
			  <li><a href="viewcertificates.php?status=Reject">View Rejected</a></li>
			  <li><a href="#"><hr></a></li>
			  <li><a href="certificatetype.php">Add Certificate Type</a></li>
			  <li><a href="viewcertificatetype.php">View Certificate Type</a></li>
			</ul> 
		</li>
		...
		?>
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Staff Panel</a>
            <ul class="dropdown-menu" role="menu">
		  	...
		  	{
		  	?>
                      <li><a href="user.php">Add Staff</a></li>
                      <li><a href="viewuser.php">View Staff</a></li>
          	<?php
			}
			?>
            </ul>
		...
		?>
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Certifications</a>
            	<ul class="dropdown-menu" role="menu">
              		<li><a href="newcertificate.php">Add New Certificate</a></li>
              		<li><a href="viewcertificates.php">View Uploaded Certificates</a></li>
              	</ul>
           	</li>
      ...
      <div class="col-lg-12 col-md-12">
        <div class="latest_newsarea"> <span>Latest News</span>
          ...
          <div class="social_area">
            <ul class="social_nav">
              <li class="facebook"><a href="https://www.facebook.com/BvritHyderabad/"></a></li>
              <li class="twitter"><a href="https://twitter.com/bvrithyderabad"></a></li>
              <li class="youtube"><a href="https://www.youtube.com/channel/UChqX3XQ774OaUFWe5Q5sdQA/videos"></a></li>
              <li class="mail"><a href="http://bvrithyderabad.edu.in/"></a></li>
            </ul>
          </div>
        </div>
      </div>
