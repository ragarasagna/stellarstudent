          ...
          <div class="single_post_content">
            ...
            <div class="single_post_content_left">
              <ul class="business_catgnav  wow fadeInDown">
                <li>
       <figure class="bsbig_fig"> <a href="single_page.php?noticeid=<?php echo $rsrecnoticeplacements['notice_id']; ?>&noticetype=Placements" class="featured_img"></figure>
          <img src="<?php 
				  /*if(file_exists("noticeimages/" . $rsrecnoticeplacements['uploads']))
				  {
				  		echo "noticeimages/" . $rsrecnoticeplacements['uploads'];
				  }
				  else
				  {
					  echo "images/no-image.png";
                  ...
                  <span class="overlay"></span>
                    <figcaption> <a href="single_page.php?noticeid=<?php echo $rsrecnoticeplacements['notice_id']; ?>&noticetype=Placements"><?php echo $rsrecnoticeplacements['title']; ?></a> </figcaption>
                  </figure>
                </li>
              </ul>
            </div>
            <!--div class="single_post_content_right"-->
              <ul class="spost_nav">
			 <?php
               $sql ="SELECT * FROM notice WHERE notice_type='Placements'";
              ...
              while($rsrec = mysqli_fetch_array($qsql))
              {
                 ...
                 echo "<li>
                      <div class='media wow fadeInDown'> <a href='single_page.php?noticeid=$rsrec[notice_id]&noticetype=Placements' class='media-left'><img src='$imgname'></a>          
                     <div class='media-body'> <a href='single_page.php?noticeid= $rsrec[notice_id]&noticetype=Placements' class='catg_title'>$rsrec[title]</a> </div>
                      </div>
                    </li>";
              }
                    ?>
