	 ...
	 while($rsrec = mysqli_fetch_array($qsql))
	  {
		  ...
		  echo "<li style='background-color:#FFBBFF;width:100%'><div id='comment' style='background-color:#FFBBFF;width:100%'>";
					...
					echo $rsstudent['student_name'];
					 ...
					 {
					echo " | &nbsp;<a href='single_page_discussion.php?discussionid=$_GET[discussionid]&subject=$_GET[subject]&delid=$rsrec[discussion_reply_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a>";
					 }
					...
					echo "<br><span style='color:black;'><i class='fa fa-calendar'></i>&nbsp; Published on " . date("D d M Y h:i:s ",$dtcommentstime) . "</span></li>";
