...
if($_SESSION['sessionid'] == $_POST['sessionid'])
{
	...
	if(isset($_POST['submit']))
	{
		...
		else
		{
			...
			{
				$sql="INSERT INTO student(student_name,roll_no,password,student_img,course_id,semester,about_student,email_id,mob_no,status,batch) values ('$_POST[name]','$_POST[rollno]','$ectpass','$imgname','$_POST[course]','$_POST[semester]','$aboutus','$_POST[emailid]','$_POST[mobileno]','Pending','$_POST[batch]')";
				$qsql = mysqli_query($con,$sql);
				if(!$qsql)
				{
					echo mysqli_error($con);
          ...
          <div class="contact_area">
            ...
            <input  type="hidden" name="sessionid" value="<?php echo $_SESSION['sessionid']; ?>" >
              ...
              <?php
               ...
               <span id="idname"></span>
              	<br>
				Batch (Enter starting year):<font color='red' size='4'><strong>*</strong></font>
              <input name="batch" id="batch" class="form-control" type="number" placeholder="Enter starting year" value="<?php echo $rsedit['batch']; ?>" min="1950" max="<?php echo date("Y"); ?>" />
...
?>
              ...
              <input name="confirmpassword" class="form-control" type="password" placeholder="Confirm Password" value="<?php echo $rsedit['password']; ?>">
               <span id="idconfirmpassword"></span>
              	<br>
              Profile Image:<font color='red' size='4'><strong>*</strong></font>
 ...
 <br>
			  ...
			  ?>><?php echo $rsedit['about_student']; ?></textarea>
             <br />        	
 ...
 function validateform()
 {
	...
	document.getElementById("idbatch").innerHTML ="";
	 ...
	 {
		 document.getElementById("idrollno").innerHTML ="<font color='red'>Only Alpha numeric values allowed....</font>";
		 validatecondtion=1;
	 }
