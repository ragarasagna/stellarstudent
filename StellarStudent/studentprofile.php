      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="contact_area">
            ...
            <p>You can Update your profile here (if required).</p>
            ...
            <input  type="hidden" name="sessionid" value="<?php echo $_SESSION['sessionid']; ?>" >
              ...
              <input name="batch" id="batch" class="form-control" type="number" placeholder="Enter Year" value="<?php echo $rsedit['batch']; ?>" min="1950" max="<?php echo date("Y"); ?>" readonly />
