...
?>
  <section id="contentSection">
    <div class="row">
            <h2>View Course</h2><br>
            <p>View all course details.</p>
...
<?php  
  ...
  echo "<tr>
    ...
    <td>&nbsp;<a href='course.php?editid=$rsrec[course_id]' class='btn btn-info' >Edit</a> | <a href='viewcourse.php?delid=$rsrec[course_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a></td>
  </tr>";
  }
?>  
</tbody>
