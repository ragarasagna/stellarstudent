...
?>
  <section id="contentSection">
    <div class="row">
            ...
            <p>View discussion details done by students.</p>
  ...
  while($rsrec = mysqli_fetch_array($qsql))
  {
    ...
    <td><strong>Course:</strong> $rscourse[course]<hr><strong>Subject:</strong> $rssubject[subject]</td>
    <td><b style='color:red'>$rsrec[discussion_title]</b>&nbsp;$rsrec[discussion_description]</td>
    <td>&nbsp;" . date("d-m-Y",strtotime($rsrec['date_time'])) . "</td>
