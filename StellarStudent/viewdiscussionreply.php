...
?>
 ...
 while($rsrec = mysqli_fetch_array($qsql))
  ...
  echo "<tr>
	...
	<td>&nbsp;<a href='discussionreply.php?editid=$rsrec[discussion_reply_id]' class='btn btn-info' >Edit</a><br><a href='viewdiscussionreply.php?delid=$rsrec[discussion_reply_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a></td>
  </tr>";
  }
  ?>
  </tbody>
