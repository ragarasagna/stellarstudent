...
?>
   ...
   while($rsrec = mysqli_fetch_array($qsql))
  {
    ...
    <td>&nbsp;<img src='noticeimages/$rsrec[uploads]' style='width: 75px;height: 75px;' /></td>
    <td>&nbsp;$rsrec[date_time]</td>
	<td>&nbsp;<a href='notice.php?editid=$rsrec[notice_id]' class='btn btn-info' >Edit</a><br><a href='viewnotice.php?delid=$rsrec[notice_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a></td>
    </tr>";
  }
  ?>
  </tbody>
