...
?>
  <section id="contentSection">
    <div class="row">
           <h2>View Quiz</h2><br>
            <p>View the quizzes and questions. You can select the subject to add more questions to the particular quiz.</p>
 ...
 while($rsrec = mysqli_fetch_array($qsql))
  {
	...
	{
    echo "<a href='quiz.php?editid=$rsrec[quiz_id]' class='btn btn-info' >Edit</a> |";
	}
	echo "<a href='viewquiz.php?delid=$rsrec[quiz_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a></td>
	  </tr>";
  }
  ?>
  </tbody>
