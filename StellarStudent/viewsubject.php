...
?>
  ...
  while($rsrec = mysqli_fetch_array($qsql))
  {
    ...
    <td>&nbsp;$rsrec[note]</td>
	<td>&nbsp;<a href='subject.php?editid=$rsrec[subject_id]' class='btn btn-info' >Edit</a> | <a href='viewsubject.php?delid=$rsrec[subject_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a></td>
  </tr>";
  }
  ?>
  </tbody>
