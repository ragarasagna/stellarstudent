...
?>
  ...
  while($rsrec = mysqli_fetch_array($qsql))
  {
    ...
    <td>&nbsp;<a href='timelinecomment.php?editid=$rsrec[timeline_comment_id]' class='btn btn-info' >Edit</a><br><a href='viewtimelinecomment.php?delid=$rsrec[timeline_comment_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a></td>
    </tr>";
  }
  ?>
  </tbody>
