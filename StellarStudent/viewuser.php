...
?>
  <section id="contentSection">
    <div class="row">
         <h2>View Users</h2><br>
            <p>View all the different users like admin and the staff.</p>
  ...
  while($rsrec = mysqli_fetch_array($qsql))
  {
    ...
    <td>&nbsp;$rsrec[status]</td>
    <td>&nbsp;<a href='user.php?editid=$rsrec[user_id]' class='btn btn-info' >Edit</a><br> <a href='viewuser.php?delid=$rsrec[user_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a></td>
  </tr>";
  }
  ?>
  </tbody>
