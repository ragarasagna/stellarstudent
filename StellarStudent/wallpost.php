...
if(isset($_POST['submit']))
{
	...
	if(mysqli_affected_rows($con) == 1)
	{
		echo "<SCRIPT>alert('Record published in Wallpost...');</SCRIPT>";
...
?>
  <section id="contentSection">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        ...
        <!-- ################ -->
            ...
            <div class="tab-content">
              ...
              Text:
              <textarea name="text" id="text" class="form-control" cols="30" rows="3" placeholder="Enter message"></textarea>
              <span id="idtext"></span>
              <br />
         ...
         <hr>
              ...
              Message:
              <textarea name="message" class="form-control" cols="30" rows="3" placeholder="Enter message"><?php echo $rsedit['text_message']; ?></textarea>
              Image:
              ...
              <br />
              <input name="submit1" type="submit" value="Publish Image">
             </form>
         <hr>
                </div>
              </div>
            ...
            <input type="file" name="video"  class="form-control" value="<?php echo $rsedit['video_path']; ?>" accept="video/*" onchange="loadFile(event)">
              ...
              <br />
              <input name="submit2" type="submit" value="Publish Video">
            </form>
         <hr>
              </div>
	...
	{
		echo " | <a href='wallpost.php?delid=$rstimeline[timeline_id]' class='btn btn-danger' >Delete</a> ";
	}
						 echo "<br>
...
echo "<br><span><i class='fa fa-calendar'></i>&nbsp; Published on " . date("D d M Y ",$dttime) . "</span>";	
